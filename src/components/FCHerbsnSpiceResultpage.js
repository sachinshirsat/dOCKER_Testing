...
import './FCHerbsnSpiceResultpage.css';

function FCHerbsnSpiceResultpage() {
    return (
        <div>
            <section className='fnc-herbnspice-result-image0'></section>
            <section className='fnc-herbnspice-result-text'>
                <h2 className='fnc-herbnspice-result-resulth2'>Mint: Freshness packed in a Leaf</h2>
                <p className='fnc-herbnspice-result-resultp'>India is a multi-faceted country, and her forts and monuments are a source of pride and honor, as they reflect the architecture and lifestyle of a bygone era. The vision behind fort architecture goes a long way in representing India’s vast, rich and varied cultural history.</p>
                <p className='fnc-herbnspice-result-resultp'>
            ...
            <section className='fnc-herbnspice-result-image7'></section>
            <section className='fnc-herbnspice-result-text'>
                {/* <h2> Parallax</h2> */}
                <p className='fnc-herbnspice-result-resultp'>The Amer Fort exhibits the glory and legacy of the Kachwaha dynasty, which lasted for more than a century. The spectacular architecture of this monument remains unmatched to this day. The Fort stands as a grand reminder of the glory of the Kachwaha Rajputs and is recognized as a UNESCO World Heritage site.</p>
                <p className='fnc-herbnspice-result-resultp'>
...
export default FCHerbsnSpiceResultpage
