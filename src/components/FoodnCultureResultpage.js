...
import './FoodnCultureResultpage.css';

function FoodnCultureResultpage() {
    return (
        <div>
            <section className='fnc-result-image0'></section>
            <section className='fnc-result-text'>
                <h2 className='fnc-result-resulth2'>Evolution of Indian Gastronomy: A Tale of Fusion</h2>
                <p className='fnc-result-resultp'>India is a multi-faceted country, and her forts and monuments are a source of pride and honor, as they reflect the architecture and lifestyle of a bygone era. The vision behind fort architecture goes a long way in representing India’s vast, rich and varied cultural history.</p>
                <p className='fnc-result-resultp'>
...
export default FoodnCultureResultpage
