...
import './FCFoodFestivalsResultpage.css' ;

function FCFoodFestivalsResultpage() {
    return (
        <div>
            <section className='fnc-foodfest-result-image0'></section>
            <section className='fnc-foodfest-result-text'>
                <h2 className='fnc-foodfest-result-resulth2'>Easter - Harbinger of New Life & Hope</h2>
                <p className='fnc-foodfest-result-resultp'>India is a multi-faceted country, and her forts and monuments are a source of pride and honor, as they reflect the architecture and lifestyle of a bygone era. The vision behind fort architecture goes a long way in representing India’s vast, rich and varied cultural history.</p>
                <p className='fnc-foodfest-result-resultp'>
...
export default FCFoodFestivalsResultpage
